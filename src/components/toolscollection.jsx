...
export default function Tools() {
    ...
    return <div className="flex flex-col my-10 mx-4 overflow-x-hidden">
        ...
        <div className="flex animate-marquee whitespace-nowrap w-max p-5">
            {tools.concat(tools).map((tool, index) => (
                <div key={index} 
                 className="bg-white  border-blue-200 border-[1px] shadow-lg/40 shadow-[#2a41e8] flex flex-col justify-center p-4 items-center rounded-xl cursor-pointer transition-all mx-2  ">
